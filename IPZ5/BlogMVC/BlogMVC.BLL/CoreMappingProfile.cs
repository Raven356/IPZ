...
namespace BlogMVC.BLL
{
    public class CoreMappingProfile : Profile
    {
        public CoreMappingProfile() 
        {
            ...
            CreateMap<Author, AuthorDTO>().ForMember(dst => dst.Image, opt => opt.Ignore()).ForMember(dst => dst.ImagePath, opt => opt.MapFrom(s => s.Image)).ReverseMap().ForMember(dst => dst.Image, opt => opt.Ignore());
            CreateMap<BlogPost, BlogPostDTO>().ReverseMap();
            CreateMap<Category, CategoryDTO>().ReverseMap();
            CreateMap<User, UserDTO>().ReverseMap();
            CreateMap<BlogPost, CreateBlogPostDTO>().ForMember(dst => dst.Image, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(dst => dst.Image, opt => opt.Ignore());
